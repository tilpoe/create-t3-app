    ...
    >
      ...
      <FieldGroup
        ...
        className={twJoin(
          ...
          "[&>[data-slot=suffix]>button]:data-focus-visible:outline-1 [&>[data-slot=suffix]>button]:data-focus-visible:outline-offset-1 [&>[data-slot=suffix]>button]:mr-[calc(var(--spacing)*-1.15)] [&>[data-slot=suffix]>button]:rounded-md",
      ...
      >
        ...
        {isRevealable ? (
          <ButtonPrimitive
            ...
            className="data-focus-visible:*:data-[slot=icon]:text-primary *:data-[slot=icon]:text-muted-fg outline-hidden relative mr-1 grid shrink-0 place-content-center rounded-sm border-transparent"
          >
